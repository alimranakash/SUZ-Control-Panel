...
require_once plugin_dir_path( __FILE__ ) . 'includes/event-related-queries.php'; // Event-related lecture/speaker Elementor queries
require_once plugin_dir_path( __FILE__ ) . 'includes/event-status-queries.php'; // Event status Elementor queries (upcoming/running/future/expired)
